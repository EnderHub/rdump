...
2. - [ ] Example runs successfully with `--features async`
3. - [ ] Works with `cargo run --features async --example async_search`

**Content:**
4. - [ ] Shows basic async streaming
5. - [ ] Shows early termination pattern
6. - [ ] Shows concurrent stream processing
7. - [ ] Shows integration with other async operations
8. - [ ] Shows error handling in async context

**Code Quality:**
9. - [ ] Includes helpful comments
10. - [ ] Shows practical async patterns
11. - [ ] Demonstrates tokio integration

**Output:**
12. - [ ] Produces clear, informative output
13. - [ ] Shows timing for async operations

## Tasks / Subtasks

- [ ] Create example file `examples/async_search.rs` (AC: 1, 2, 3)
- [ ] Implement example functions (AC: 4-8)
  - [ ] `example_basic_async()` - basic streaming
  - [ ] `example_early_termination()` - take N results
  - [ ] `example_concurrent_streams()` - multiple searches
  - [ ] `example_with_other_async()` - file writing, HTTP
  - [ ] `example_error_handling()` - async error patterns
- [ ] Add helpful comments (AC: 9, 10, 11)
- [ ] Ensure good output (AC: 12, 13)
